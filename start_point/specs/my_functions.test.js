...
describe('functions practice', () => {
  ...
  test('volume of cube side 3 is 27', () => {
    expect(myFunctions.cube(3)).toBe(27);
  });

  // Given the radius of a sphere calculate the volume
  test('volume of sphere radius 10 is 4188.79', () => {
    expect(myFunctions.sphereVol(10)).toBe(4188.79);
  });

  test('0 degrees farenheit is -17.78 celcius', () => {
    expect(myFunctions.fToC(0)).toBe(-17.78);
  });
